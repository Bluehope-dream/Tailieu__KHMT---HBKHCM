...
class Army {
    ...
    //BattleField* battleField;                 //Ơ mục này task 3.7  sẽ thêm hàm trận địa vào
...
public:
    ...
    Army(Unit **unitArray, int size, string name);  // Dùng LF tính bằng tổng điểm getScore của các phương tiện Vehicle 
